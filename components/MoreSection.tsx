            ...
            return (
              <article key={post.id} className="group">
                <Link href={`/${post.slug}`}>
                  ...
                  <h3 className="font-display font-extrabold text-[17px] sm:text-[18px] md:text-[20px] leading-[1.2] mb-2 group-hover:text-primary-red transition-colors duration-300">
                    {decodeHtmlEntities(post.title.rendered)}
                  </h3>

                  <div className="flex items-center gap-2 text-[10px] sm:text-[11px] font-sans uppercase tracking-wide">
                    {authorSlug && (
